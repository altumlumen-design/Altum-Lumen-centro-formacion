...
(() => {
  ...
  const VERSION = '20260921-sira-361';
  const SIRA_BRIDGE_URL = 'https://script.google.com/macros/s/AKfycbysdGK_9D_nDDrhj6pa53_4H6eOT0U3k_KBqZ1iX_Co7oTCvdEAqnE5Sac1ZRAugfZo/exec?action=registroBridge';
   ...
   */
  window.REGISTROS_PUBLICOS = Object.freeze([{ __sira_bridge__: true }]);
  window.REGISTROS_PUBLICOS_META = Object.freeze({
    version: VERSION,
    mode: 'SIRA_PEDA_PRIVATE_BRIDGE',
    baseHistorica: 0,
    actualizacion: 0,
    total: 0
  });
